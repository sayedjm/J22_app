 document.addEventListener("DOMContentLoaded", function() {
        var implementedDate = document.getElementById("implemented_date").value;
        if (implementedDate !== "") {
            var implementedDateSpan = document.getElementById("implemented_date-span");
        ...
        if (orderedDate !== "") {
            var orderedDateSpan = document.getElementById("ordered_date-span");
            orderedDateSpan.textContent = " (" + calculateDaysAgo(orderedDate, "besteld") + ")";
        }

        var contactedDate = document.getElementById("contacted_date").value;
        if (contactedDate !== "") {
